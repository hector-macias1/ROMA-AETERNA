...
public class Level2State extends GameState{
	...
	public void init() {
		...
		try {
			hageonText = ImageIO.read(
				getClass().getResourceAsStream("/HUD/roma.gif")
			);
	...
	private void populateEnemies() {
		...
		gp.setPosition(1900, 100);
		enemies.add(gp);
		gp = new Germano(tileMap, player);
		gp.setPosition(1920, 100);
		enemies.add(gp);
		gp = new Germano(tileMap, player);
		gp.setPosition(1940, 100);
		enemies.add(gp);
		gp = new Germano(tileMap, player);
		gp.setPosition(2350, 50);
		enemies.add(gp);
		gp = new Germano(tileMap, player);
		gp.setPosition(2370, 50);
		enemies.add(gp);
		gp = new Germano(tileMap, player);
		gp.setPosition(3340, 120);
		enemies.add(gp);
		gp = new Germano(tileMap, player);
		gp.setPosition(3360, 120);
		enemies.add(gp);
		gp = new Germano(tileMap, player);
		gp.setPosition(3380, 120);
		
		
		g = new Fuego(tileMap);
		g.setPosition(1155, 80);
		enemies.add(g);
		g = new Fuego(tileMap);
